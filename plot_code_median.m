...
MSFD_rel2 = median(MSFD_Result.relErr2);
MSFD_relF = median(MSFD_Result.relErrF);
MSFD_time = median(MSFD_Result.timetot);
...
plot(r, norm_rel2, 'bo-', r,dct_rel2,'c*-', r,spemb_rel2,'rx-', r, freq_rel2, 'ks-', r, MSFD_rel2, 'kd--', r,spfd5_rel2,'gd-',...
...
l = legend('NormSamp', 'DCT', 'SpEmb', 'FD', 'MSFD','SpFD5', 'SpFD10', 'SpFD50');
set(l, 'fontsize', 14)

figure(2)   % relative error F norm
plot(r, norm_relF, 'bo-', r,dct_relF,'c*-', r,spemb_relF,'rx-', r, freq_relF, 'ks-', r, MSFD_relF, 'kd--', r,spfd5_relF,'gd-',...
...
figure(3)   % total time
plot(r, norm_time, 'bo-', r,dct_time,'c*-', r,spemb_time,'rx-', r, freq_time, 'ks-', r, MSFD_time, 'kd--',r,spfd5_time,'gd-',...
